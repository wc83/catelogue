...
counter=0
with open('/Users/william/Documents/scanner/all_stations/EXP_all_coincidence_V1.csv') as f:
    reader = csv.reader(f)
    next(reader, None)
    for row in reader:
...
file_ls01= open('/Users/william/Documents/scanner/LS01/LS01_all_eq_scan_v1.txt','w')
file_ls02= open('/Users/william/Documents/scanner/LS02/LS02_all_eq_scan_v1.txt','w')
file_ls03= open('/Users/william/Documents/scanner/LS03/LS03_all_eq_scan_v1.txt','w')
file_ls04= open('/Users/william/Documents/scanner/LS04/LS04_all_eq_scan_v1.txt','w')
file_ls05= open('/Users/william/Documents/scanner/LS05/LS05_all_eq_scan_v1.txt','w')
file_ls06= open('/Users/william/Documents/scanner/LS06/LS06_all_eq_scan_v1.txt','w')
...
#%% All LS01 triggered events
    ...
    for x in range(0,len(on_off1s)):
        start1s=trace1s.stats.starttime
        onset1s=start1s+(on_off1s[x,0]/sr) 
        offset1s= start1s+(on_off1s[x,1]/sr)
        rt=onset1s.timestamp
        value=rt
        near_lb,ind=find_nearest(on_off_all[:,0], value)
        if abs(near_lb - value) < 30:   
            
            near,ix=find_nearest(ts[:,0], value)
            if abs(near-value) > 30:
