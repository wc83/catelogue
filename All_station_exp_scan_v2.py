...
#%%
file_exp = open('/Users/william/Documents/scanner/all_stations/All_exp_scan_v2g.txt','w')
file_cor2 = open('/Users/william/Documents/scanner/all_stations/All_correlated2_exp_scan_v2g.txt','w')
file_lb01= open('/Users/william/Documents/scanner/LB01/LB01_all_exp_scan_v2g.txt','w')
file_lb02= open('/Users/william/Documents/scanner/LB02/LB02_all_exp_scan_v2g.txt','w')
file_lb03= open('/Users/william/Documents/scanner/LB03/LB03_all_exp_scan_v2g.txt','w')
file_lb04= open('/Users/william/Documents/scanner/LB04/LB04_all_exp_scan_v2g.txt','w')
file_lb05= open('/Users/william/Documents/scanner/LB05/LB05_all_exp_scan_v2g.txt','w')
file_lb06= open('/Users/william/Documents/scanner/LB06/LB06_all_exp_scan_v2g.txt','w')
file_ls01= open('/Users/william/Documents/scanner/LS01/LS01_all_exp_scan_v2g.txt','w')
file_ls02= open('/Users/william/Documents/scanner/LS02/LS02_all_exp_scan_v2g.txt','w')
file_ls03= open('/Users/william/Documents/scanner/LS03/LS03_all_exp_scan_v2g.txt','w')
file_ls04= open('/Users/william/Documents/scanner/LS04/LS04_all_exp_scan_v2g.txt','w')
file_ls05= open('/Users/william/Documents/scanner/LS05/LS05_all_exp_scan_v2g.txt','w')
file_ls06= open('/Users/william/Documents/scanner/LS06/LS06_all_exp_scan_v2g.txt','w')
        ...
        if switch1s ==1:
            ...
            for t in range(0,int(trace1s.stats.npts/100), step):
                ...
                if amp > av_amp1s:                
                    ...
                    if (1.5 < cf < 3.25) and (1.1 < peak < 2.75) and (0.1 < bwid < 2.25): 
                             #correlate between data and earthquake envelopes 
        ...
        if switch2s ==1:
            ...
            for t in range(0,int(trace2s.stats.npts/100), step):
                ...
                if amp > av_amp2s:  
                    ...
                    if (1.5 < cf2 < 3.5) and (1.1 < peak2 < 2.3) and (0.1 < bwid2 < 2.2):
                             #correlate between data and earthquake envelopes 
        ...
        if switch3s ==1:
            ...
            for t in range(0,int(trace3s.stats.npts/100), step):
                ...
                if amp > av_amp3s:       
                    ...
                    if (1.75 < cf3 < 5) and (1.1 < peak3 < 3) and (0.1 < bwid3 < 3.25):
                             #correlate between data and earthquake envelopes 
        ...
        if switch4s ==1:
            ...
            for t in range(0,int(trace4s.stats.npts/100), step):
                ...
                if amp > av_amp4s:       
                    ...
                    if (2.25 < cf4 < 5) and (1.1 < peak4 < 2.75) and (0.1 < bwid4 < 4.75): 
                             #correlate between data and earthquake envelopes 
        ...
        if switch5s ==1:
            ...
            for t in range(0,int(trace5s.stats.npts/100), step):
                ...
                if amp > av_amp5s:       
                    ...
                    if (1.5 < cf5 < 4.5) and (1.1 < peak5 < 2.5) and (0.1 < bwid5 < 2.5): 
                             #correlate between data and earthquake envelopes 
        ...
        if switch6s ==1:
            ...
            for t in range(0,int(trace6s.stats.npts/100), step):
                ...
                if amp > av_amp6s:       
                    ...
                    if (1.25 < cf6 < 2.5) and (1.1 < peak6 < 2.5) and (0.1 < bwid6 < 2.5): 
                             #correlate between data and earthquake envelopes 
...
#%% 
print("End of Scan")
np.savetxt("/Users/william/Documents/scanner/all_stations/Explosions_per_day_V2g.csv", Events_per_day,delimiter=",",header="Number_of_Events,Day_number")            

col=0       
cor_events=cor_events[np.argsort(cor_events[:,col])] 
if cor_events[0,0]== 0.0:
    cor_events = np.delete(cor_events, (0), axis=0)       
np.savetxt("/Users/william/Documents/scanner/all_stations/EXP_all_coincidence_V2g.csv", cor_events,delimiter=",",header="Time_stamp,Day_number,Year,Day_of_year,Hour,Min,Sec,Milisec,LBO1,LB02,LB03,LB04,LB05,LB06,LSO1,LS02,LS03,LS04,LS05,LS06")
...
if len(data_stream) > 0:            
    data_stream.write('/Users/william/Documents/scanner/output_data/EXP_all_data_stream_v2g.mseed', format='MSEED')         
#%%
