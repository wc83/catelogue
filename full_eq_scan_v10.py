...
fmax=12
#%%
file_sta = open('/Users/william/Documents/scanner/all_stations/full_eq_scan_v10.txt','w')
file_cor2 = open('/Users/william/Documents/scanner/all_stations/full_correlated2_eq_scan_v10.txt','w')
file_lb01= open('/Users/william/Documents/scanner/LB01/LB01_full_eq_scan_v10.txt','w')
file_lb02= open('/Users/william/Documents/scanner/LB02/LB02_full_eq_scan_v10.txt','w')
file_lb03= open('/Users/william/Documents/scanner/LB03/LB03_full_eq_scan_v10.txt','w')
file_lb04= open('/Users/william/Documents/scanner/LB04/LB04_full_eq_scan_v10.txt','w')
file_lb05= open('/Users/william/Documents/scanner/LB05/LB05_full_eq_scan_v10.txt','w')
file_lb06= open('/Users/william/Documents/scanner/LB06/LB06_full_eq_scan_v10.txt','w')

#%% Read in waveforms 
  
trc2_e1,trc2_e2,trc2_e3,trc2_e4,trc2_e5,trc2_e6=stacked_LBz_eq() 
...
#        if amp > 300:
#            if amp_rat < 15:
        if (5 < cf < 11) and (3 < peak < 13) and (2 < bwid < 12):
...
#        if amp > 3000:
#            if amp_rat < 15:
        if (5 < cf < 11) and (4 < peak < 13) and (0.2 < bwid < 9):
#                            
            trs_e = obspy.signal.filter.envelope(tr.data)
...
#        if amp > 40000:
#            if amp_rat < 15:
        if (5 < cf < 12.5) and (4 < peak < 13.5) and (1 < bwid < 10.5):
...
#        if amp > 20000:
#            if amp_rat < 15:
        if (3.5 < cf < 11) and (2 < peak < 12) and (0.7 < bwid < 11):
#                           
            trs_e = obspy.signal.filter.envelope(tr.data)
...
#        if amp > 20000:
#            if amp_rat < 15:
        if (4 < cf < 10) and (2.5 < peak < 11) and (1.5 < bwid < 10.5):
...
#        if amp > 2000:
#            if amp_rat < 15:
        if (5 < cf < 10) and (3.5 < peak < 11) and (2.5 < bwid < 9.5) :  
...
np.savetxt("/Users/william/Documents/scanner/all_stations/EQ_coincidence_V1.csv", corr_event2,delimiter=",",header="Time_stamp,Event_length,Day_number,Year,Day_of_year,Hour,Min,Sec,Milisec,LBO1,LB02,LB03,LB04,LB05,LB06")

for r in range(0,len(corr_event2)):
    if corr_event2[r][9]==1:
        tr1a=stream1[int(corr_event2[r][2])]
        dstart=UTCDateTime(corr_event2[r][0])
        tr1_save = tr1a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][10]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr2_save = tr2a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][11]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr3_save = tr3a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][12]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr4_save = tr4a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][13]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr5_save = tr5a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][14]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr6_save = tr6a.slice(starttime=dstart, endtime=dstart+corr_event2[r][1]+20)
