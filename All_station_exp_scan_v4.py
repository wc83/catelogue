...
#%%
file_exp = open('/Users/william/Documents/scanner/all_stations/All_exp_scan_2_month_31_32.txt','w')
file_cor2 = open('/Users/william/Documents/scanner/all_stations/All_correlated2_exp_scan_2_month_31_32.txt','w')
...
file_lb03= open('/Users/william/Documents/scanner/LB03/LB03_all_exp_scan_2_month_31_32.txt','w')
...
#%% 
print("End of Scan")
np.savetxt("/Users/william/Documents/scanner/all_stations/Explosions_per_day_2_month_31_32.csv", Events_per_day,delimiter=",",header="Number_of_Events,Day_number")            

col=0       
cor_events=cor_events[np.argsort(cor_events[:,col])] 
if cor_events[0,0]== 0.0:
    cor_events = np.delete(cor_events, (0), axis=0)       
np.savetxt("/Users/william/Documents/scanner/all_stations/EXP_all_coincidence_2_month_31_32.csv", cor_events,delimiter=",",header="Time_stamp,Day_number,Year,Day_of_year,Hour,Min,Sec,Milisec,LBO1,LB02,LB03,LB04,LB05,LB06,LSO1,LS02,LS03,LS04,LS05,LS06")
...
if len(data_stream) > 0:            
    data_stream.write('/Users/william/Documents/scanner/output_data/EXP_all_data_stream_2_month_31_32.mseed', format='MSEED')         
#%%
