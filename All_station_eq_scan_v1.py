...
file_cor2 = open('/Users/william/Documents/scanner/all_stations/All_correlated2_eq_scan_v1.txt','w')
file_lb01= open('/Users/william/Documents/scanner/LB01/LB01_all_eq_scan_v1.txt','w')
file_lb02= open('/Users/william/Documents/scanner/LB02/LB02_all_eq_scan_v1.txt','w')
file_lb03= open('/Users/william/Documents/scanner/LB03/LB03_all_eq_scan_v1.txt','w')
file_lb04= open('/Users/william/Documents/scanner/LB04/LB04_all_eq_scan_v1.txt','w')
file_lb05= open('/Users/william/Documents/scanner/LB05/LB05_all_eq_scan_v1.txt','w')
file_lb06= open('/Users/william/Documents/scanner/LB06/LB06_all_eq_scan_v1.txt','w')
file_ls01= open('/Users/william/Documents/scanner/LB01/LS01_all_eq_scan_v1.txt','w')
file_ls02= open('/Users/william/Documents/scanner/LB02/LS02_all_eq_scan_v1.txt','w')
file_ls03= open('/Users/william/Documents/scanner/LB03/LS03_all_eq_scan_v1.txt','w')
file_ls04= open('/Users/william/Documents/scanner/LB04/LS04_all_eq_scan_v1.txt','w')
file_ls05= open('/Users/william/Documents/scanner/LB05/LS05_all_eq_scan_v1.txt','w')
file_ls06= open('/Users/william/Documents/scanner/LB06/LS06_all_eq_scan_v1.txt','w')
...
#%% All LS01 triggered events
    ...
    for x in range(0,len(on_off1s)):
        ...
        tr = trace1s.slice(starttime=onset1s - 15 , endtime=offset1s +25)
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
...
#                            
    ...
    for x in range(0,len(on_off2s)):
        ...
        tr = trace2s.slice(starttime=onset2s -15 , endtime=offset2s +25)
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
...
#%% LB03 only events
    ...
    for x in range(0,len(on_off3s)):
        ...
        tr = trace3s.slice(starttime=onset3s -15, endtime=offset3s +25 )
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
    ...
    for x in range(0,len(on_off4s)):
        ...
        tr = trace4s.slice(starttime=onset4s -15, endtime=offset4s +25)        
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
    ...
    for x in range(0,len(on_off5s)):
        ...
        tr = trace5s.slice(starttime=onset5s -15, endtime=offset5s +25)
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
    ...
    for x in range(0,len(on_off6s)):
        ...
        tr = trace6s.slice(starttime=onset6s -15, endtime=offset6s +25)
        tr.detrend(type='demean')
        tr.detrend(type='linear')
        tr_len=tr.stats.endtime - tr.stats.starttime 
        peak,cf,bwid,bwid25 = freq_info(tr.data,tr.stats.starttime,tr.stats.endtime)      
...
np.savetxt("/Users/william/Documents/scanner/all_stations/EQ_all_coincidence_V1.csv", corr_event2,delimiter=",",header="Time_stamp,Event_length,Day_number,Year,Day_of_year,Hour,Min,Sec,Milisec,LBO1,LB02,LB03,LB04,LB05,LB06,LSO1,LS02,LS03,LS04,LS05,LS06")
...
for r in range(0,len(corr_event2)):
    ...
    if corr_event2[r][16]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr2s_save = tr2a.slice(starttime=dstart - 10, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][17]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr3s_save = tr3a.slice(starttime=dstart - 10, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][18]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr4s_save = tr4a.slice(starttime=dstart - 10, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][19]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr5s_save = tr5a.slice(starttime=dstart - 10, endtime=dstart+corr_event2[r][1]+20)
    ...
    if corr_event2[r][20]==1:
        ...
        dstart=UTCDateTime(corr_event2[r][0])
        tr6s_save = tr6a.slice(starttime=dstart - 10, endtime=dstart+corr_event2[r][1]+20)
        tr6s_save.detrend(type='demean')
        tr6s_save.detrend(type='linear')
        data_stream.append(tr6s_save)


data_stream.write('/Users/william/Documents/scanner/output_data/EQ_all_data_stream_v1.mseed', format='MSEED')         
